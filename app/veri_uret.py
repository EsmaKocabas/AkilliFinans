...
# 1. Müşteri Verisi (Sentetik): Şehrin 3 farklı yoğunluk bölgesi (Örn: Çarşı, AVM, Kampüs)
# loc: Merkez koordinatı, scale: Dağılım genişliği, size: Müşteri sayısı
...
# Tüm müşterileri birleştir ve tablo (DataFrame) yap
musteriler = np.vstack([bolge_1, bolge_2, bolge_3])
df_musteriler = pd.DataFrame(musteriler, columns=['X', 'Y'])

# 2. ATM Aday Noktaları: Şehrin her yerine rastgele dağılmış 50 nokta
