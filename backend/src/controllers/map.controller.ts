...
export class MapController {
  public static async getAtms(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  public static async getNearbyAtms(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  public static async optimizeAtms(req: Request, res: Response, next: NextFunction) {
    try {
